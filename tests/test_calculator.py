...
def test_generated_operations(clear_calculations, operation, num_one, num_two, expected):
    """Test dynamically generated operations using Faker."""
    assert getattr(Calculator, operation)(num_one, num_two) == expected
